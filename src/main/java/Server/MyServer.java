...
public class MyServer {
    ...
    public synchronized void privateMsg(String to, String msg) {
        for (ClientHandler o : clients.values()) {
            if (to.equals(o.getName())) {
                o.sendMsg(msg);
            }
        }
    }
    ...
    public synchronized void privateMsg(String from, String to, String msg) {
        privateMsg(to, formatMessage(from,msg));
    }
